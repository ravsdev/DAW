...
/**
 * Clase vehículo, nos permite gestionar la información de un coche (marca,matrícula,kms,precio y descripción),
 * la fecha de matriculación y el nombre del propietario
